                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      ...
                      <span className="text-purple-300 font-semibold">CAPSOLVER_API_KEY</span> in the bot server's .env file.
                      Free tier at <a href="https://capsolver.com" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">capsolver.com</a>.
                    </p>
                  </div>
                </div>
              </div>
