                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      ...
                      <span className="text-purple-300 font-semibold">CAPMONSTER_API_KEY</span> in your <span className="text-purple-300 font-semibold">Netlify → Environment Variables</span>.
                      Get key at <a href="https://capmonster.cloud" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">capmonster.cloud</a>.
                    </p>
                  </div>
                </div>
              </div>
