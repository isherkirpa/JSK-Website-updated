        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Join or leave Discord servers with multiple tokens</p>
            </div>
          </div>
        </div>
      </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      Discord may show hCaptcha for some invites. For auto-solving, add{" "}
                      <span className="text-purple-300 font-semibold">CAPSOLVER_API_KEY</span> in your <span className="text-purple-300 font-semibold">Netlify → Environment Variables</span>.
                      Get free credits at <a href="https://capsolver.com" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:underline">capsolver.com</a>.
                    </p>
                  </div>
                </div>
              </div>
