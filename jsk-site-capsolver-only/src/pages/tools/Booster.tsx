      ...
      <div className="hero-bg py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black text-white">Server Boost</h1>
          ...
          <div className="space-y-5">
            ...
            <button onClick={handleBoost}
              ...
              {running
                ...
                : <><Zap size={16} /> Start Boost ({tokenCount} token{tokenCount !== 1 ? "s" : ""})</>
              }
            </button>
          </div>
          ...
          <div className="card-dark rounded-2xl p-5 flex flex-col">
            ...
            {results.length === 0 && !running ? (
              <div className="flex-1 flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-gray-600 text-sm">Fill in the config,<br />then click "Start Boost".</p>
              </div>
            ) : (
...
export default function Booster() {
  return (
    <KeyGate toolId="booster" toolName="Server Boost">
